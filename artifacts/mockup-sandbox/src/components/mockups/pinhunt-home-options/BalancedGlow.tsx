  ...
  return (
    <main className="phg-shell">
      <style>{`
        ...
        @keyframes phg-gradient-drift{0%,100%{background-position:0% 45%}50%{background-position:100% 55%}}@keyframes phg-orbit{0%,100%{transform:translate3d(0,0,0) rotate(0deg)}50%{transform:translate3d(-10px,-7px,0) rotate(8deg)}}@keyframes phg-glint{0%,72%,100%{opacity:.26;transform:translateX(-12px) rotate(25deg)}84%{opacity:.5;transform:translateX(12px) rotate(25deg)}}.phg-find{width:100%;min-height:139px;position:relative;overflow:hidden;padding:18px;text-align:left;border-radius:25px;background:linear-gradient(115deg,#ea6339 0%,#f58b2a 48%,#ffc95f 100%);background-size:180% 180%;animation:phg-gradient-drift 9s ease-in-out infinite;color:#fffaf0;box-shadow:0 13px 28px #da71355c;transition:transform .2s ease,box-shadow .2s ease}.phg-find:hover{transform:translateY(-2px);box-shadow:0 17px 30px #da71356c}.phg-find:before{content:"";position:absolute;width:145px;height:145px;border-radius:50%;border:25px solid #ffda7a55;right:-55px;bottom:-65px;animation:phg-orbit 7s ease-in-out infinite}.phg-find:after{content:"";position:absolute;width:80px;height:80px;border-radius:20px;border:1px solid #fff7d477;transform:rotate(25deg);right:31px;top:-46px;animation:phg-glint 8s ease-in-out infinite}.phg-findcopy{position:relative;z-index:1;width:190px}.phg-findlabel{display:flex;align-items:center;gap:5px;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#fff0c9}.phg-find h1{font-size:27px;line-height:28px;margin:8px 0 5px;font-weight:850;letter-spacing:-.05em}.phg-find p{font-size:13px;margin:0;color:#fff5dc;line-height:17px;font-weight:500}.phg-findicon{position:absolute;right:22px;bottom:20px;z-index:1;width:48px;height:48px;border-radius:17px;background:#fff8dc;display:grid;place-items:center;color:#dd6133;box-shadow:0 7px 13px #b6493040}
        ...
        .phg-section{margin-top:20px}.phg-sectionhead{display:flex;justify-content:space-between;align-items:baseline;margin:0 2px 9px}.phg-sectionhead h2{font-size:14px;margin:0;font-weight:850;letter-spacing:-.025em}.phg-sectionhead button{background:none;padding:0;font-size:11px;font-weight:750;color:#d85d36}.phg-update{display:flex;width:100%;align-items:center;gap:12px;border:1px solid #f1d9c4;border-radius:21px;padding:11px;background:#fffaf1;text-align:left;box-shadow:0 5px 14px #c6815314}.phg-update-icon{width:40px;height:40px;border-radius:14px;background:#ffe5a4;display:grid;place-items:center;color:#cf6922;flex-shrink:0}.phg-update-text{min-width:0;flex:1}.phg-update-text b{display:block;font-size:13px;line-height:15px}.phg-update-text span{display:block;margin-top:2px;font-size:11px;color:var(--muted);font-weight:550}.phg-update>svg{color:#bd7a61;flex-shrink:0}.phg-event{display:block;width:100%;padding:13px 13px 12px;border:1px solid #e6b2a3;border-radius:21px;background:linear-gradient(135deg,#fff8e9 0%,#ffe4cb 100%);text-align:left;box-shadow:0 6px 16px #b95a4417;transition:transform .2s ease,box-shadow .2s ease}.phg-event:hover{transform:translateY(-2px);box-shadow:0 9px 18px #b95a4425}.phg-eventtop{display:flex;align-items:center;gap:9px}.phg-eventicon{width:37px;height:37px;display:grid;place-items:center;border-radius:13px;background:#733d58;color:#ffdf9a;flex-shrink:0}.phg-eventmeta{min-width:0;flex:1}.phg-official{display:inline-flex;align-items:center;gap:4px;padding:4px 7px;border-radius:99px;background:#f2c26e;color:#6c3549;font-size:9px;line-height:1;font-weight:850;letter-spacing:.04em;text-transform:uppercase}.phg-eventmeta b{display:block;margin-top:6px;font-size:13px;line-height:15px}.phg-event>span:last-child{display:block;padding-left:46px;margin-top:6px;font-size:11px;line-height:14px;color:#835b5e;font-weight:650}.phg-event>svg{float:right;margin-top:-18px;color:#b45d4d}
      ...
      <div className="phg-scroll">
        ...
        <button type="button" onClick={() => setFound(!found)} className="phg-find" aria-label="Find a pin">
          <span className="phg-findcopy"><span className="phg-findlabel"><Sparkles size={13}/> {found ? "Ready when you are" : "Start here"}</span><h1>Find a Pin</h1><p>Scan or search the catalogue</p></span>
        ...
        <section className="phg-section">
          ...
          <button type="button" onClick={noop} className="phg-event" aria-label="Open PinHunt UK Community Swap announcement">
            <span className="phg-eventtop"><span className="phg-eventicon"><Megaphone size={18}/></span><span className="phg-eventmeta"><span className="phg-official"><BadgeCheck size={11}/> PinHunt UK official</span><b>PinHunt UK Community Swap</b></span></span>
            <span><CalendarDays size={12} style={{ display: "inline", verticalAlign: "-2px", marginRight: "4px" }}/>Sat 12 Sept · London · Posted by PinHunt UK</span><ChevronRight size={17}/>
          </button>
      ...
      <style>{`
        @media (prefers-reduced-motion: reduce){.phg-find{animation:none;background-position:50% 50%}.phg-find:before,.phg-find:after{animation:none}.phg-find:hover,.phg-event:hover{transform:none}}
      `}</style>
