  ...
  return (
    <main className="phs-shell">
      <style>{`
        ...
        .phs-find{width:100%;min-height:139px;position:relative;overflow:hidden;padding:18px;text-align:left;border-radius:25px;background:linear-gradient(120deg,#d95e5b 0%,#e97868 54%,#efb174 100%);background-size:155% 155%;color:#fffdf5;box-shadow:0 13px 28px #c96e6660;transition:transform .2s ease,box-shadow .2s ease;isolation:isolate;animation:phs-find-drift 9s ease-in-out infinite}.phs-find:hover{transform:translateY(-2px);box-shadow:0 17px 30px #c96e666c}.phs-find:before{content:"";position:absolute;width:145px;height:145px;border-radius:50%;border:25px solid #ffdba064;right:-55px;bottom:-65px;z-index:-1;animation:phs-find-orbit 10s ease-in-out infinite}.phs-find:after{content:"";position:absolute;width:80px;height:80px;border-radius:20px;border:1px solid #fff8e577;right:31px;top:-46px;z-index:-1;transform:rotate(25deg);animation:phs-find-diamond 7s ease-in-out infinite}.phs-find-orbit{position:absolute;border:1px solid #fff4dc4d;border-radius:50%;pointer-events:none;z-index:-1}.phs-find-orbit-one{width:205px;height:72px;right:-47px;top:24px;transform:rotate(-23deg);animation:phs-find-orbit-one 8s ease-in-out infinite}.phs-find-orbit-two{width:112px;height:35px;right:11px;bottom:20px;transform:rotate(31deg);border-color:#ffdba080;animation:phs-find-orbit-two 6s ease-in-out infinite reverse}.phs-findcopy{position:relative;z-index:1;width:190px}.phs-findlabel{display:flex;align-items:center;gap:5px;font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#fff2d7}.phs-find h1{font-size:27px;line-height:28px;margin:8px 0 5px;font-weight:850;letter-spacing:-.05em}.phs-find p{font-size:13px;margin:0;color:#fff6e8;line-height:17px;font-weight:500}.phs-findicon{position:absolute;right:22px;bottom:20px;z-index:1;width:48px;height:48px;border-radius:17px;background:#fff3dc;display:grid;place-items:center;color:var(--coral-deep);box-shadow:0 7px 13px #a44f4840}.phs-findicon svg{transition:transform .25s ease}.phs-find:active .phs-findicon svg{transform:rotate(-8deg) scale(.94)}@keyframes phs-find-drift{0%,100%{background-position:0% 50%}50%{background-position:100% 45%}}@keyframes phs-find-orbit{0%,100%{transform:translate3d(0,0,0) rotate(0deg)}50%{transform:translate3d(-13px,-8px,0) rotate(13deg)}}@keyframes phs-find-diamond{0%,100%{transform:rotate(25deg) translate3d(0,0,0);opacity:.72}50%{transform:rotate(39deg) translate3d(-7px,8px,0);opacity:1}}@keyframes phs-find-orbit-one{0%,100%{transform:rotate(-23deg) translate3d(0,0,0);opacity:.45}50%{transform:rotate(-13deg) translate3d(-7px,6px,0);opacity:.85}}@keyframes phs-find-orbit-two{0%,100%{transform:rotate(31deg) translate3d(0,0,0);opacity:.5}50%{transform:rotate(23deg) translate3d(7px,-5px,0);opacity:.95}}@media (prefers-reduced-motion:reduce){.phs-find,.phs-find:before,.phs-find:after,.phs-find-orbit-one,.phs-find-orbit-two{animation:none}.phs-find{background-position:50% 50%}}
        ...
        .phs-section{margin-top:20px}.phs-sectionhead{display:flex;justify-content:space-between;align-items:baseline;margin:0 2px 9px}.phs-sectionhead h2{font-size:14px;margin:0;font-weight:850;letter-spacing:-.025em}.phs-sectionhead button{background:none;padding:0;font-size:11px;font-weight:750;color:var(--coral-deep)}.phs-update{display:flex;width:100%;align-items:center;gap:12px;border:1px solid var(--line);border-radius:21px;padding:11px;background:var(--paper);text-align:left;box-shadow:0 5px 14px #55998c12}.phs-update-icon{width:40px;height:40px;border-radius:14px;background:#f6dfab;display:grid;place-items:center;color:#a77a35;flex-shrink:0}.phs-update-text{min-width:0;flex:1}.phs-update-text b{display:block;font-size:13px;line-height:15px}.phs-update-text span{display:block;margin-top:2px;font-size:11px;color:var(--muted);font-weight:550}.phs-update>svg{color:#7ca3a0;flex-shrink:0}.phs-event{display:flex;width:100%;align-items:center;gap:10px;border:1px solid #e5c985;border-radius:21px;padding:11px;background:#fff8e9;text-align:left;box-shadow:0 5px 14px #c8954b16}.phs-event-mark{width:40px;height:40px;border-radius:14px;background:#16525a;color:#f6dfab;display:grid;place-items:center;flex-shrink:0}.phs-event-copy{min-width:0;flex:1}.phs-event-kicker{display:flex;align-items:center;gap:4px;color:#a77a35;font-size:9px;font-weight:850;letter-spacing:.08em;line-height:12px}.phs-event-kicker svg{color:#3b9e99}.phs-event-copy b{display:block;font-size:12px;line-height:15px;color:var(--ink)}.phs-event-meta{display:flex;align-items:center;gap:4px;margin-top:3px;color:var(--muted);font-size:10.5px;font-weight:650}.phs-event-meta svg{color:var(--coral-deep)}.phs-event>svg{color:#7ca3a0;flex-shrink:0}
      ...
      <div className="phs-scroll">
        ...
        <button type="button" onClick={() => setFound(!found)} className="phs-find" aria-label="Find a pin"><span className="phs-find-orbit phs-find-orbit-one" aria-hidden="true"/><span className="phs-find-orbit phs-find-orbit-two" aria-hidden="true"/><span className="phs-findcopy"><span className="phs-findlabel"><Sparkles size={13}/> {found ? "Ready when you are" : "Start here"}</span><h1>Find a Pin</h1><p>Scan or search the catalogue</p></span><span className="phs-findicon">{found ? <Search size={23}/> : <Camera size={23}/>}</span></button>
        ...
        <section className="phs-section"><div className="phs-sectionhead"><h2>For You</h2><button type="button" onClick={noop}>See all</button></div><button type="button" onClick={noop} className="phs-event" aria-label="Open PinHunt UK Community Swap event"><span className="phs-event-mark"><CalendarDays size={18}/></span><span className="phs-event-copy"><span className="phs-event-kicker"><BadgeCheck size={12}/> PINHUNT UK · OFFICIAL</span><b>PinHunt UK Community Swap</b><span className="phs-event-meta"><MapPin size={12}/> Sat 12 Sept · London</span></span><ChevronRight size={17}/></button><button type="button" onClick={noop} className="phs-update"><span className="phs-update-icon"><Sparkles size={18}/></span><span className="phs-update-text"><b>Your submission is live</b><span>Festival of Fantasy Mickey was approved</span></span><ChevronRight size={17}/></button></section>
